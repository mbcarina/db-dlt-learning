# dab_dlt_learning : testing cicd databricks : FIRST PR: 001

The 'dab_dlt_learning' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dab_dlt_learning/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dab_dlt_learning_etl` to your workspace.
